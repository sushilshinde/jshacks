(function (jsonConfigFile) {
  (function (cp) {
    ...
    var statusDiv = '<div onclick="this.remove()" alt="Click to hide" title="Click to hide" style="background-color: black; color: white;position: fixed; top: 0;center:0; left:40%; width: 400px; height:50px;" align="center"><p  id="loadingStatus" style="style="background-color: black; color: white;">loading....</p></div>'
